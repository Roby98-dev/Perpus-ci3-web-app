                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <?php if (!empty($announce)) : ?>
                            ...
                            <?php else : ?>
                                <div class="alert alert-danger"><?= $announce; ?></div>
                            <?php endif; ?>
                        <?php endif; ?>
                        <form method="post" action="<?= base_url() ?>anggota/submit" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
